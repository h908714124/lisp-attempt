...
class TestPredecessor {
    ...
    void testPredecessorOfZero() {
        ...
        Assertions.assertEquals("(lambda (f x) (((lambda (f1 x1) x1) (lambda (g h) (h (g f))) (lambda (u) x)) (lambda (u1) u1)))", result.get(1).toString());
        Assertions.assertEquals("(lambda (f x) ((lambda (u) x) (lambda (u1) u1)))", result.get(2).toString());
    ...
    void testPredecessorOfOne() {
        ...
        List<Exp> result = Eval.iterEval(exp);
        Assertions.assertEquals("(lambda (f x) (((lambda (f1 x1) (f1 x1)) (lambda (g h) (h (g f))) (lambda (u) x)) (lambda (u1) u1)))", result.get(1).toString());
        Assertions.assertEquals("(lambda (f x) (((lambda (g h) (h (g f))) (lambda (u) x)) (lambda (u1) u1)))", result.get(2).toString());
        Assertions.assertEquals("(lambda (f x) ((lambda (h) (h ((lambda (u) x) f))) (lambda (u1) u1)))", result.get(3).toString());
        Assertions.assertEquals("(lambda (f x) ((lambda (u1) u1) ((lambda (u) x) f)))", result.get(4).toString());
    ...
    void testPredecessorOfTwo() {
        ...
        List<Exp> result = Eval.iterEval(exp);
        Assertions.assertEquals("(lambda (f x) (((lambda (f1 x1) (f1 (f1 x1))) (lambda (g h) (h (g f))) (lambda (u) x)) (lambda (u1) u1)))", result.get(1).toString());
        Assertions.assertEquals("(lambda (f x) (((lambda (g h) (h (g f))) ((lambda (g h) (h (g f))) (lambda (u) x))) (lambda (u1) u1)))", result.get(2).toString());
        Assertions.assertEquals("(lambda (f x) ((lambda (h) (h (((lambda (g1 h1) (h1 (g1 f))) (lambda (u) x)) f))) (lambda (u1) u1)))", result.get(3).toString());
