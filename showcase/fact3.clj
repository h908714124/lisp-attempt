...
(fn [f x] (((((fn [f] ((fn [x] (x x)) (fn [x] (f (x x))))) fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (((((fn [x] (x x)) (fn [x] (fact_ (x x)))) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
...
(fn [f x] (f (((((fn [f] ((fn [x] (x x)) (fn [x] (f (x x))))) fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f (((((fn [x] (x x)) (fn [x] (fact_ (x x)))) (pred (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
...
(fn [f x] (f (f (((((fn [f] ((fn [x] (x x)) (fn [x] (f (x x))))) fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f (((((fn [x] (x x)) (fn [x] (fact_ (x x)))) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
...
(fn [f x] (f (f (f (((((fn [f] ((fn [x] (x x)) (fn [x] (f (x x))))) fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f (f (((((fn [x] (x x)) (fn [x] (fact_ (x x)))) (pred (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) x))))))
...
(fn [f x] (f (f (f (f (((((fn [f] ((fn [x] (x x)) (fn [x] (f (x x))))) fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
(fn [f x] (f (f (f (f (((((fn [x] (x x)) (fn [x] (fact_ (x x)))) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
...
(fn [f x] (f (f (f (f (f (((((fn [f] ((fn [x] (x x)) (fn [x] (f (x x))))) fact_) (pred (pred (pred 3)))) f) x)))))))
(fn [f x] (f (f (f (f (f (((((fn [x] (x x)) (fn [x] (fact_ (x x)))) (pred (pred (pred 3)))) f) x)))))))
