...
((fn [a b] b) 1 (* 1 ((Y fact_) (pred 1))))
((fn [b] b) (* 1 ((Y fact_) (pred 1))))
(* 1 ((Y fact_) (pred 1)))
...
(fn [f x] (((((fn [x] x) ((K true) (K false))) 1 (* (pred 1) ((Y fact_) (pred (pred 1))))) f) x))
...
(fn [f x] ((((fn [a b] a) 1 (* (pred 1) ((Y fact_) (pred (pred 1))))) f) x))
(fn [f x] ((((fn [b] 1) (* (pred 1) ((Y fact_) (pred (pred 1))))) f) x))
(fn [f x] ((1 f) x))
