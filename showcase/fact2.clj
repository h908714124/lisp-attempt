...
(fn [f x] ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred 2)) f) ((((Y fact_) (pred 2)) f) x)))
...
(fn [f x] ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred 2) ((Y fact_) (pred (pred 2)))) f) ((((Y fact_) (pred 2)) f) x)))
(fn [f x] ((((fn [n] (fn [f1 x1] ((pred 2) (n f1) x1))) ((Y fact_) (pred (pred 2)))) f) ((((Y fact_) (pred 2)) f) x)))
(fn [f x] (((fn [f1 x1] ((pred 2) (((Y fact_) (pred (pred 2))) f1) x1)) f) ((((Y fact_) (pred 2)) f) x)))
(fn [f x] ((fn [x1] ((pred 2) (((Y fact_) (pred (pred 2))) f) x1)) ((((Y fact_) (pred 2)) f) x)))
(fn [f x] ((pred 2) (((Y fact_) (pred (pred 2))) f) ((((Y fact_) (pred 2)) f) x)))
...
(fn [f x] ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred 2))) f) ((((Y fact_) (pred 2)) f) x)))
...
(fn [f x] (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred 2)) f) x)))
...
(fn [f x] (f ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred 2) ((Y fact_) (pred (pred 2)))) f) x)))
(fn [f x] (f ((((fn [n] (fn [f1 x1] ((pred 2) (n f1) x1))) ((Y fact_) (pred (pred 2)))) f) x)))
(fn [f x] (f (((fn [f1 x1] ((pred 2) (((Y fact_) (pred (pred 2))) f1) x1)) f) x)))
(fn [f x] (f ((fn [x1] ((pred 2) (((Y fact_) (pred (pred 2))) f) x1)) x)))
(fn [f x] (f ((pred 2) (((Y fact_) (pred (pred 2))) f) x)))
(fn [f x] (f (1 (((Y fact_) (pred (pred 2))) f) x)))
(fn [f x] (f ((((Y fact_) (pred (pred 2))) f) x)))
(fn [f x] (f (((fact_ (Y fact_) (pred (pred 2))) f) x)))
(fn [f x] (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred 2))) f) x)))
