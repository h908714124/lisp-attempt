...
public class IsDefnExpression implements ExpVisitor<Optional<DefnExpression>, Void> {
    ...
    @Override
    public Optional<DefnExpression> visitSexp(Sexp sexp, Void _null) {
        if (!sexp.head().accept(IS_DEFN_SYMBOL, _null)) {
