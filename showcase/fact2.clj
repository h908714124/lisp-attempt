...
(fn [f x] (((((pred 1) (K false) true) 1 (* (pred (pred 2)) ((Y fact_) (pred (pred (pred 2)))))) f) ((((Y fact_) (pred 2)) f) x)))
(fn [f x] ((((0 (K false) true) 1 (* (pred (pred 2)) ((Y fact_) (pred (pred (pred 2)))))) f) ((((Y fact_) (pred 2)) f) x)))
...
(fn [f x] (f (((((pred 1) (K false) true) 1 (* (pred (pred 2)) ((Y fact_) (pred (pred (pred 2)))))) f) x)))
(fn [f x] (f ((((0 (K false) true) 1 (* (pred (pred 2)) ((Y fact_) (pred (pred (pred 2)))))) f) x)))
