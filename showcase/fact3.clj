...
(fn [f x] (((fact_ (Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x))))
(fn [f x] ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x))))
...
(fn [f x] ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred 3) ((Y fact_) (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x))))
(fn [f x] ((((fn [n] (fn [f1 x1] ((pred 3) (n f1) x1))) ((Y fact_) (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x))))
(fn [f x] (((fn [f1 x1] ((pred 3) (((Y fact_) (pred (pred 3))) f1) x1)) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x))))
(fn [f x] ((fn [x1] ((pred 3) (((Y fact_) (pred (pred 3))) f) x1)) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x))))
(fn [f x] ((pred 3) (((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x))))
...
(fn [f x] (((fact_ (Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
...
(fn [f x] ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred (pred 3)) ((Y fact_) (pred (pred (pred 3))))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] ((((fn [n] (fn [f1 x1] ((pred (pred 3)) (n f1) x1))) ((Y fact_) (pred (pred (pred 3))))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (((fn [f1 x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f1) x1)) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] ((fn [x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) x1)) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
...
(fn [f x] (((fact_ (Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
...
(fn [f x] (f (((fact_ (Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
...
(fn [f x] (f ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred (pred 3)) ((Y fact_) (pred (pred (pred 3))))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f ((((fn [n] (fn [f1 x1] ((pred (pred 3)) (n f1) x1))) ((Y fact_) (pred (pred (pred 3))))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f (((fn [f1 x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f1) x1)) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f ((fn [x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) x1)) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
...
(fn [f x] (f (((fact_ (Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
...
(fn [f x] (f (f (((fact_ (Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred 3)) f) ((((Y fact_) (pred 3)) f) x)))))
...
(fn [f x] (f (f ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred 3) ((Y fact_) (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f (f ((((fn [n] (fn [f1 x1] ((pred 3) (n f1) x1))) ((Y fact_) (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f (f (((fn [f1 x1] ((pred 3) (((Y fact_) (pred (pred 3))) f1) x1)) f) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f (f ((fn [x1] ((pred 3) (((Y fact_) (pred (pred 3))) f) x1)) ((((Y fact_) (pred 3)) f) x)))))
(fn [f x] (f (f ((pred 3) (((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x)))))
...
(fn [f x] (f (f (((fact_ (Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
...
(fn [f x] (f (f ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred (pred 3)) ((Y fact_) (pred (pred (pred 3))))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f ((((fn [n] (fn [f1 x1] ((pred (pred 3)) (n f1) x1))) ((Y fact_) (pred (pred (pred 3))))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f (((fn [f1 x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f1) x1)) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f ((fn [x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) x1)) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
...
(fn [f x] (f (f (((fact_ (Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
...
(fn [f x] (f (f (f (((fact_ (Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred 3)) f) x))))))
...
(fn [f x] (f (f (f ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred (pred 3)) ((Y fact_) (pred (pred (pred 3))))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f (f ((((fn [n] (fn [f1 x1] ((pred (pred 3)) (n f1) x1))) ((Y fact_) (pred (pred (pred 3))))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f (f (((fn [f1 x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f1) x1)) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f (f ((fn [x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) x1)) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f (f ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) x))))))
...
(fn [f x] (f (f (f (((fact_ (Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred 3)) f) x))))))
...
(fn [f x] (f (f (f (f (((fact_ (Y fact_) (pred 3)) f) x))))))
(fn [f x] (f (f (f (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred 3)) f) x))))))
...
(fn [f x] (f (f (f (f ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred 3) ((Y fact_) (pred (pred 3)))) f) x))))))
(fn [f x] (f (f (f (f ((((fn [n] (fn [f1 x1] ((pred 3) (n f1) x1))) ((Y fact_) (pred (pred 3)))) f) x))))))
(fn [f x] (f (f (f (f (((fn [f1 x1] ((pred 3) (((Y fact_) (pred (pred 3))) f1) x1)) f) x))))))
(fn [f x] (f (f (f (f ((fn [x1] ((pred 3) (((Y fact_) (pred (pred 3))) f) x1)) x))))))
(fn [f x] (f (f (f (f ((pred 3) (((Y fact_) (pred (pred 3))) f) x))))))
(fn [f x] (f (f (f (f (2 (((Y fact_) (pred (pred 3))) f) x))))))
(fn [f x] (f (f (f (f ((((Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
(fn [f x] (f (f (f (f (((fact_ (Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
(fn [f x] (f (f (f (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred 3))) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
...
(fn [f x] (f (f (f (f ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred (pred 3)) ((Y fact_) (pred (pred (pred 3))))) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
(fn [f x] (f (f (f (f ((((fn [n] (fn [f1 x1] ((pred (pred 3)) (n f1) x1))) ((Y fact_) (pred (pred (pred 3))))) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
(fn [f x] (f (f (f (f (((fn [f1 x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f1) x1)) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
(fn [f x] (f (f (f (f ((fn [x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) x1)) ((((Y fact_) (pred (pred 3))) f) x)))))))
(fn [f x] (f (f (f (f ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
...
(fn [f x] (f (f (f (f (((fact_ (Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
(fn [f x] (f (f (f (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred (pred 3)))) f) ((((Y fact_) (pred (pred 3))) f) x)))))))
...
(fn [f x] (f (f (f (f (f (((fact_ (Y fact_) (pred (pred 3))) f) x)))))))
(fn [f x] (f (f (f (f (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred 3))) f) x)))))))
...
(fn [f x] (f (f (f (f (f ((((fn [m n] (fn [f1 x1] (m (n f1) x1))) (pred (pred 3)) ((Y fact_) (pred (pred (pred 3))))) f) x)))))))
(fn [f x] (f (f (f (f (f ((((fn [n] (fn [f1 x1] ((pred (pred 3)) (n f1) x1))) ((Y fact_) (pred (pred (pred 3))))) f) x)))))))
(fn [f x] (f (f (f (f (f (((fn [f1 x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f1) x1)) f) x)))))))
(fn [f x] (f (f (f (f (f ((fn [x1] ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) x1)) x)))))))
(fn [f x] (f (f (f (f (f ((pred (pred 3)) (((Y fact_) (pred (pred (pred 3)))) f) x)))))))
...
(fn [f x] (f (f (f (f (f (((fact_ (Y fact_) (pred (pred (pred 3)))) f) x)))))))
(fn [f x] (f (f (f (f (f ((((fn [f1 n] ((zero? n) 1 (* n (f1 (pred n))))) (Y fact_) (pred (pred (pred 3)))) f) x)))))))
